...
export const MOCK_USERS: User[] = [
  ...
  },
  {
    ...
    gender: "male",
    location: "ベトナム・ハノイ",
    registration_date: "2025年01月05日"
  },
];

export const MOCK_FAVORITES = [
  { user_id: 1, store_id: 1 },
  { user_id: 1, store_id: 3 },
  { user_id: 1, store_id: 5 },
  { user_id: 1, store_id: 6 },
  { user_id: 2, store_id: 2 },
  { user_id: 2, store_id: 4 },
  { user_id: 3, store_id: 7 },
  { user_id: 4, store_id: 8 },
  { user_id: 4, store_id: 1 },
  { user_id: 4, store_id: 5 },
];
